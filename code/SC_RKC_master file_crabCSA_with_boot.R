...
SC_RKC_boot_fit <- crabbootSC(dataset=SCred, CSAoutput=SC_RKC_fit1a, B=2)
...
crabboot.graph(CSAout = SC_RKC_fit1a, bootout = SC_RKC_boot_fit , 
               title = "SC_RKC red crab", min= 0)
crabboot.graph(CSAout = SC_RKC_fit1, bootout = boot_fit , 
               title = "SC_RKC red crab", min= 0)
crabboot.Legal.graph(CSAout = SC_RKC_fit1a, bootout = SC_RKC_boot_fit , 
                     title = "SC_RKC Legal crab", min= 0)
crabboot.Mature.graph(CSAout = SC_RKC_fit1a, bootout = SC_RKC_boot_fit , 
                     title = "SC_RKC Legal crab", min= 0)
crabboot.LM.graph(CSAout = SC_RKC_fit1a, bootout = SC_RKC_boot_fit , 
